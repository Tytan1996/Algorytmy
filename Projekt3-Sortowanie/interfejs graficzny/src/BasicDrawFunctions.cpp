...
void AiSD::display()
{
    ...
    }else
    {
        ...
        if(!getProcessing())
        {
            ...
            {
                newCollection.addNew({convertSize(0.0f,140.0f),convertSize(200.0f,50.0f),"Save Sorted",false,7,14,[](){savePreset(saveFile(),GeneratePresetStruct("File generated by program",false));}});
                newCollection.addNew({convertSize(0.0f,210.0f),convertSize(200.0f,50.0f),"Save Unsorted",false,8,15,[](){savePreset(saveFile(),GeneratePresetStruct("File generated by program",true));}});
            }
        }
        if(openMenuActive==true)
        {
            if(alreadySorted==false)
                ...
                newCollection.addNew({convertSize(0.0f,140.0f),convertSize(200.0f,50.0f),"Save",false,10,17,[](){savePreset(saveFile(),GeneratePresetStruct("File generated by program",false));}});
        }
