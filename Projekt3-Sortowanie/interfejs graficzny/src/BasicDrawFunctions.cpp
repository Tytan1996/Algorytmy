...
void onStart()
{
    ...
    newCollection.addNew({convertSize(600.0f,550.0f),convertSize(200.0f,50.0f),"Start",false,3,10,[](){Start();}});//newCollection.boxes.clear();menuActive=false;
    newCollection.addNew({convertSize(0.0f,550.0f),convertSize(200.0f,50.0f),"Open",false,3,11,[](){ApplyPresetStruct(openPreset(openFile()));}});
